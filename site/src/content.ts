...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    metaDescription:
      'Wohnung vor der Vermietung sanieren und vermietbar machen: richtige Reihenfolge, welche Arbeiten sich lohnen, was Interessenten zuerst sehen, Kosten und Leerstand.',
    title: 'Wohnung sanieren vor der Vermietung: Ablauf & Reihenfolge',
    excerpt:
      'Ich habe genug Baustellen gesehen, die aus dem Ruder liefen – fast immer war es dieselbe Ursache: die falsche Reihenfolge. So machen Sie eine Wohnung sauber vermietbar: mit der richtigen Reihenfolge, den Arbeiten, die sich wirklich lohnen, und einem ehrlichen Blick auf Kosten und Leerstand.',
    datum: '2026-07-22',
    kategorie: 'Sanierung',
    lesezeit: '9 Min.',
    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          'Ob eine Wohnung schnell vermietbar ist, entscheidet sich früher, als man denkt. In den ersten Minuten einer Besichtigung zählt der Gesamteindruck, nicht das Detail. Vier Dinge fallen dabei sofort auf – im Guten wie im Schlechten:',
        ],
        list: [
